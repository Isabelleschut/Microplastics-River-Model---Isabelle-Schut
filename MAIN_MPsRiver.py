...
#RIVER COMPARTMENTS
riverComp = ["1", "2", "3", "4"]
compartments = ["Surface Water", "Epilimnion", "Hypolimnion", "Sediment"]
...
#SIZE BINS
sizeBin =["a", "b", "c", "d", "e"]
sizeBinLabel = ["1um", "5um","10um", "50um", "100um"]# Detection limit for MPs via Fourier Transform Infrared Spectroscopy is 20um
